...
class CreatePlantService:
    ...
    def get_all_plants(self):
        try:
            self.plants = list(self.db_connector.db.plant.find())
            return self.plants
    ...
    def get_plants_by_id(self, plant_id):
        try:
            self.plants = self.db_connector.db.plant.find_one({'_id': plant_id})
            return self.plants
        except Exception as e:
    ...
    def update_plant(self, plant_id, updated_data):
        try:
            updated_plant = self.get_plants_by_id(plant_id)
            if updated_plant:
    ...
    def delete_plant(self, plant_id):
        try:
            deleted_plant = self.get_plants_by_id(plant_id)
            if deleted_plant:
